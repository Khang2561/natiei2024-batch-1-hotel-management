...
public class RoomCategoriesController {
	...
	// XÓA PHÒNG
	@PostMapping("/delete")
	public String deleteRoom(@RequestParam("roomID") String roomID, Model model) {
	...
	@PostMapping("/update")
	public String updateRoom(@RequestParam("roomID") String roomID, @RequestParam("nameRoom") String nameRoom,
			@RequestParam("typeRoom") String typeRoomId, @RequestParam("noteRoom") String note) {
		System.out.println("Bắt đầu update ");
		// In các giá trị đầu vào
		System.out.println("roomID: " + roomID);
		System.out.println("nameRoom: " + nameRoom);
		System.out.println("typeRoomId: " + typeRoomId);
		System.out.println("noteRoom: " + note);
	...
	@PostMapping("/add")
	public String addRoom(@RequestParam("nameRoom") String nameRoom, @RequestParam("typeRoom") String typeRoomID,
		...
		try {
			...
			newRoom.setRoomID(roomService.generateUniqueRoomID()); // Tạo ID mới
